...
//        self.configureSearchBar()
    ...
    private func configureSearchBar(){
        ...
        suggestionList.append("Very long vegetable to show you that cell is updated and fit all the rowVery long vegetable to show you that cell is updated and fit all the row ")
    ...
    private func configureSearchBarWithUrl(){
        ...
        suggestionListWithUrl.append(ModernSearchBarModel(title: "Charlie ? Well, just a long sentence to show you how powerful is this lib...Charlie ? Well, just a long sentence to show you how powerful is this lib...Charlie ? Well, just a long sentence to show you how powerful is this lib...Charlie ? Well, just a long sentence to show you how powerful is this lib...", url: "https://github.com/PhilippeBoisney/ModernSearchBar/raw/master/Examples%20Url/exampleC.png"))
